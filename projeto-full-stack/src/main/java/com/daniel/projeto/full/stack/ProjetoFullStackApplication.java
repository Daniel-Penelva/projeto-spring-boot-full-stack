package com.daniel.projeto.full.stack;
...
import com.daniel.projeto.full.stack.domain.Estado;
import com.daniel.projeto.full.stack.domain.ItemPedido;
import com.daniel.projeto.full.stack.domain.Pagamento;
import com.daniel.projeto.full.stack.domain.PagamentoComBoleto;
import com.daniel.projeto.full.stack.domain.PagamentoComCartao;
import com.daniel.projeto.full.stack.domain.Pedido;
import com.daniel.projeto.full.stack.domain.Produto;
import com.daniel.projeto.full.stack.domain.enums.EstadoPagamento;
import com.daniel.projeto.full.stack.domain.enums.TipoCliente;
import com.daniel.projeto.full.stack.repositories.CategoriaRepository;
import com.daniel.projeto.full.stack.repositories.CidadeRepository;
import com.daniel.projeto.full.stack.repositories.ClienteRepository;
import com.daniel.projeto.full.stack.repositories.EnderecoRepository;
import com.daniel.projeto.full.stack.repositories.EstadoRepository;
import com.daniel.projeto.full.stack.repositories.ItemPedidoRepository;
import com.daniel.projeto.full.stack.repositories.PagamentoRepository;
import com.daniel.projeto.full.stack.repositories.PedidoRepository;
import com.daniel.projeto.full.stack.repositories.ProdutoRepository;
...
public class ProjetoFullStackApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Instanciando os objetos da relação Produto e Categoria
		...
		Cidade c2 = new Cidade(null, "Uberlância", est2);
